...
public void submitOrder(String email,String pwd,String productName) throws InterruptedException, IOException {

ProductCatalouge productCatalouge=landingPage.loginApplication(email, pwd);
...
public Object[][] getData(){
	return new Object[][] {{"test12@gamil.com","Test@123","ZARA COAT 3"},{"test12@gamil.com","Test@123","ADIDAS ORIGINAL"}};
}
